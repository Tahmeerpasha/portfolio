        ...
        <div className='w-full'>
            ...
            <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
                <div className='col-span-4'>
                    <p>Project</p>
                    <h2>Overview</h2>
                    <p>This is a TO-DO List built using HTML, CSS and JavaScript</p>
                    <button className='px-8 py-2 mt-4 mr-8'><Link href={'https://tahmeerpasha.github.io/TO-DO-List/'}>Demo</Link></button>
                    <button className='px-8 py-2 mt-4'><Link href={'https://github.com/Tahmeerpasha/TO-DO-List'}>Code</Link></button>
                </div>
