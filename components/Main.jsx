            ...
            <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex items-center justify-center'>
                <div>
                    ...
                    <h1 className='py-4 text-gray-700'>
                        Hi, I'm <span className='text-[#5651e5]'>Tahmeer</span>
                    </h1>
                    ...
                    <p className='py-4 text-gray-400 max-w-[70%] m-auto'>
                        ...
                        Currently I'm focused on building responsive front-end applications. I aspire to learn backend and devops technologies as well.
                    </p>
